...
def read_athenapk_input_file(filename: str, skip_header: bool = True) -> dict:
    """
...
def modify_athenapk_input_file(config: dict, modifications: list) -> dict:
    """
...
def format_athenapk_input_file(config_dict: dict, print_formatted: bool = False) -> str:
    """
